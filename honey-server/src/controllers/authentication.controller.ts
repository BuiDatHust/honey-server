...
import { LoginResponseDto } from '@core/dtos/auth/login-response.dto'
import { LogoutRequestDto } from '@core/dtos/auth/logout-request.dto'
...
import { RenewTokenRequestDto } from '@core/dtos/auth/renew-token-request.dto'
...
export class AuthController {
  ...
  async logout(
    ...
    await this.authUserCases.logout(body.logout_type, req['device_id'])
